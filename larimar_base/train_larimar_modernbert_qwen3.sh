...
# config yaml file
####################################################################################################
config_file=configs/config_train_larimar_modernbert_qwen3.yaml
...
encoder_name_save=$(echo "modernbert" | sed 's/\//-/g')
decoder_name_save=$(echo "qwen3" | sed 's/\//-/g')
